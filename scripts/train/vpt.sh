...
export WANDB_NAME="v-pretrain_OLA-VLM-CLIP-ViT-Llama3-8b"
...
deepspeed ola_vlm/train/train_mem.py \
    ...
    --model_name_or_path outputs/pretrain_dsg_OLA-VLM-CLIP-ViT-Llama3-8b \
    --version llava_llama_3 \
    --data_path datasets/allava/ALLaVA-Caption.json \
    --image_folder datasets/allava \
    ...
    --bf16 True \
    --output_dir outputs/v-pretrain_OLA-VLM-CLIP-ViT-Llama3-8b \
    --num_train_epochs 1 \
