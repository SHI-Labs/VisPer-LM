...
class ModelArguments:
    ...
    layer_indices: Optional[str] = "8-12-16,24,30"
    img_loss_weight: Optional[float] = 0.5
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'phi' in model_args.model_name_or_path.lower():
            model = SherlockLlavaPhi3ForCausalLM.from_pretrained(
    ...
    if model_args.vision_tower is not None:
        ...
        model.config.image_gen = {
            ...
            "img_loss_weight": model_args.img_loss_weight,
        }
